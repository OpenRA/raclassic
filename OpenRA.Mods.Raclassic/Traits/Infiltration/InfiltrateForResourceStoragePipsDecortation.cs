...
{
	sealed class InfiltrateForResourceStoragePipsDecorationInfo : WithResourceStoragePipsDecorationInfo
	{
		...
		public override object Create(ActorInitializer init) { return new InfiltrateForResourceStoragePipsDecoration(init.Self, this); }
	}

	sealed class InfiltrateForResourceStoragePipsDecoration : WithResourceStoragePipsDecoration, INotifyInfiltrated
	{
		readonly HashSet<Player> infiltrators = [];
		readonly InfiltrateForResourceStoragePipsDecorationInfo info;

		public InfiltrateForResourceStoragePipsDecoration(Actor self, InfiltrateForResourceStoragePipsDecorationInfo info)
			: base(self, info)
		{
			this.info = info;
		}
