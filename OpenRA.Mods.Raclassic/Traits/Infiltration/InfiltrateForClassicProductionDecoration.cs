...
{
	[Desc("Reveals the first actor in production to the indicated players when infiltrated.")]
	sealed class InfiltrateForClassicProductionIconDecorationInfo : WithClassicProductionIconDecorationInfo
	{
		...
		public override object Create(ActorInitializer init) { return new InfiltrateForClassicProductionIconDecoration(init.Self, this); }
	}

	sealed class InfiltrateForClassicProductionIconDecoration : WithClassicProductionIconDecoration, INotifyInfiltrated
	{
		readonly HashSet<Player> infiltrators = [];
		readonly InfiltrateForClassicProductionIconDecorationInfo info;

		public InfiltrateForClassicProductionIconDecoration(Actor self, InfiltrateForClassicProductionIconDecorationInfo info)
			: base(self, info)
		{
			this.info = info;
		}
