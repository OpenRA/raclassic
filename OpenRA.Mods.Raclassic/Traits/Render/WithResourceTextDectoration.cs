...
{
	[Desc("Displays the amount of resources the the owner has as a text overlay relative to the selection box.")]
	public class WithResourceTextDecorationInfo : WithDecorationBaseInfo
	{
		...
		public override object Create(ActorInitializer init) { return new WithResourceTextDecoration(init.Self, this); }
	...
	public class WithResourceTextDecoration : WithDecorationBase<WithResourceTextDecorationInfo>, INotifyOwnerChanged
	{
		readonly SpriteFont font;
		PlayerResources playerResources;
		Color color;

		public WithResourceTextDecoration(Actor self, WithResourceTextDecorationInfo info)
			: base(self, info)
		{
		...
		protected override IEnumerable<IRenderable> RenderDecoration(Actor self, WorldRenderer wr, int2 screenPos)
		{
			...
			var text = playerResources.GetCashAndResources().ToString();
